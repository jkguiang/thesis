...
I participated in its ideation by working with Prof. Philip Chang (without telling my advisor, at first) to make the initial calculations of the feasibility of the measurement. 
Then, I personally implemented the analysis that measures the relative sign of the \HWW and \HZZ couplings, from basic selections, to the optimization of the signal region, to the background estimation and evaluation of systematic uncertainties.
...
However, I was solely responsible for the channel described in Chapter~\ref{ch:vbsvvh}. 
