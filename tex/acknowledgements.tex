...
I participated in the ideation of this analysis by working with Prof. Philip Chang to make the initial calculations of its feasibility. 
...
This contribution is part of a larger effort to produce a highly parallelizable line-segment based tracking (LST) algorithm. 
I developed the pipeline for training the machine learning algorithm described in this chapter, and personally integrated it into the LST algorithm.
...
Although much of the code was written by me, all of this work was done in close collaboration with Diego Davila, Aashay Arora, Tom Lehman, and Xi Yang.
