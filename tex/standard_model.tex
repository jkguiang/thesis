...
Fortunately, there is way to encode essential Standard Model calculations in simple drawings, so-called ``Feynman diagrams,'' which, consequently, help experimentalists keep track of physically allowed processes. 
...
\begin{figure}[htb]
    ...
    \subfloat[]{\includegraphics[width=0.2\textwidth]{fig/feynman/vertices/qcd_vertex_ggg.pdf}\label{fig:qcd2}}\\
    \subfloat[]{\includegraphics[width=0.2\textwidth]{fig/feynman/vertices/qcd_vertex_gggg.pdf}\label{fig:qcd3}}\qquad
    \subfloat[]{\includegraphics[width=0.2\textwidth]{fig/feynman/vertices/hig_vertex_HXX.pdf}\label{fig:hig1}}\qquad
    \subfloat[]{\includegraphics[width=0.2\textwidth]{fig/feynman/vertices/hig_vertex_HHHH.pdf}\label{fig:hig2}}
...
\begin{figure}[htb]
    ...
    \caption{
        Feynman diagram for beta decay, which is mechanism behind the radioactive decay of carbon-14 (C-14), which enables carbon dating. 
    }
