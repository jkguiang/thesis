...
\begin{figure}[htb]
    \centering
    \subfloat[]{\includegraphics[width=0.25\textwidth]{fig/feynman/forces/qed_vertex.pdf}\label{fig:qed1}}\quad % TODO: make these
...
\begin{figure}[htb]
    \centering
    \subfloat[$\Pem\to\PGg+\Pem$]{\includegraphics[width=0.25\textwidth]{fig/feynman/forces/qed_vertex.pdf}\label{fig:e_to_ge}}\quad % TODO: make these
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.6\textwidth]{fig/feynman/ttbar/ttbar_onelep.pdf} % TODO: make this
    \caption{
