...
\begin{figure}[htb]
    ...
    \caption[The fundamental vertices in the Standard Model]{
        ...
        $f$ is a fermion and $X_m$ is any massive particle. 
    }
...
\begin{equation}
    L = \underbrace{\frac{1}{2}m\dot{x}^2}_\text{\substack{\text{kinetic} \\ \text{energy}}} - \underbrace{U(x)}_{\substack{\text{potential} \\ \text{energy}}}
\end{equation}
