...
\begin{figure}[htb]
    \centering
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/hbbfatjet_pt_sig_vs_bkg_stacked_logy.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/ld_vqqfatjet_pt_sig_vs_bkg_stacked_logy.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/tr_vqqfatjet_pt_sig_vs_bkg_stacked_logy.pdf}}
    \caption{
...
\begin{figure}[htb]
    \centering
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/hbbfatjet_mass_sig_vs_bkg_stacked_logy.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/ld_vqqfatjet_mass_sig_vs_bkg_stacked_logy.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/tr_vqqfatjet_mass_sig_vs_bkg_stacked_logy.pdf}}
    \caption{
...
The main background in this analysis comes from QCD multijet production. % TODO: finish this
...
\begin{figure}[htb]
    \centering
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/noqcdfix_hbbfatjet_xbb_data_vs_mc_log_objsel.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/noqcdfix_ld_vqqfatjet_xwqq_data_vs_mc_log_objsel.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/noqcdfix_tr_vqqfatjet_xwqq_data_vs_mc_log_objsel.pdf}}
    \caption{
...
\end{enumerate}
\noindent Assumption 1 is the common statistical interpretation of a histogram; that is, the \textit{PDF} can be approximated by histogramming the ParticleNet score for every fat jet in an event and normalizing it to unity. 
...
After replacing the fat jet scores in events with 3 fat jets, the ParticleNet score distribution agreement between data and MC improves significantly (Fig.~\ref{fig:vbsvvh_dataMC_fatjet_scores}), doubling the number of raw QCD MC events that pass the Preselection.
...
\begin{figure}[htb]
    \centering
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/hbbfatjet_xbb_data_vs_mc_log_objsel.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/ld_vqqfatjet_xwqq_data_vs_mc_log_objsel.pdf}}\qquad
    \subfloat{\includegraphics[width=0.3\textwidth]{fig/vbsvvh/tr_vqqfatjet_xwqq_data_vs_mc_log_objsel.pdf}}
    \caption{
        The ParticleNet scores for the \Htobb (left), leading \Vtoqq (center), and trailing \Vtoqq (right) fat jets are plotted after the analysis objects are selected. 
        The main signal MC ($\kVV = 2$) is plotted in red alongside $\kVV = 1.5$ and $\kVV = 1.3$ for comparison. 
    }
...
Critically, a term \dCorrSq is added to the loss function that trains the DNN to be decorrelated with the other arm. 
% TODO: add info from the AN appendix here
...
% More plots comparing data and MC can be found in Appendix~\ref{app:estimation}. 
...
Assessing the closure in MC, we obtain:
\begin{equation*}
