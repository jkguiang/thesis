...
\begin{figure}[htb]
    \centering
    \subfloat[]{\includegraphics[width=0.45\textwidth, valign=c]{fig/feynman/ttbar/ttV_onelep.pdf}\label{fig:ttbarH_feynman}}\qquad % TODO: make this feynman diagram (https://cds.cern.ch/record/2312113/plots)
    \subfloat[]{\includegraphics[width=0.45\textwidth, valign=c]{fig/mc_diagram.pdf}\label{fig:ttbarH_hadronize}}
    \caption{
        Lorem ipsum. Right from~\cite{Gleisberg:2008ta}.
    }
...
We do this in a particular order, however, because of the sheer size of our data---200 TB of recorded data and 900 TB of simulation in the smallest data format (Fig.~\ref{fig:data_infographic}). 
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.75\textwidth]{fig/data_infographic.png}
    \caption{
        Lorem ipsum.
    }
    \label{fig:data_infographic}
\end{figure}

We first select the HLT paths most relevant to the chosen final state (Fig.~\ref{fig:pp_to_HLT}). 
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{fig/pp_to_HLT.png}
    \caption{
        Lorem ipsum.
    }
    \label{fig:pp_to_HLT}
...
Ultimately, we select a final set of events that comprise the so-called ``signal region'' (Fig.~\ref{fig:HLT_to_SR}). 
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{fig/HLT_to_SR.png}
    \caption{
        Lorem ipsum.
    }
    \label{fig:HLT_to_SR}
