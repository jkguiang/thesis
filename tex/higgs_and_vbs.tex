...
\begin{figure}[htb]
    \centering
    \subfloat{\includegraphics[width=0.465\textwidth,valign=c]{fig/cms/particle_id_sandwich.png}}\quad
    \subfloat{\includegraphics[width=0.435\textwidth,valign=c]{fig/cms/cms_slice.png}}
    \caption{
        A schematic of a generic, general-purpose particle detector (left), based on the figure in Ref.~\cite{JainParticleID}, and a transverse slice of CMS (right), from Ref.~\cite{Barney:2120661}, showing the signals left by different kinds of particles.
    }
