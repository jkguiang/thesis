...
The CMS Experiment does not have this luxury: interesting collision events are buried amidst billions of uninteresting ones---the L1 trigger and HLT can only do so much. 
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.90\textwidth]{fig/pp_to_HLT.png}
    \caption{
        Lorem ipsum.
    }
    \label{fig:pp_to_HLT}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.90\textwidth]{fig/HLT_to_SR.png}
    \caption{
        Lorem ipsum.
    }
    \label{fig:HLT_to_SR}
