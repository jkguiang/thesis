...
\begin{figure}[htb]
    \centering
    \subfloat{\includegraphics[width=0.45\textwidth]{fig/vbswh/fireworks/signal/vbswh_evt131104_rphi_gen.png}}\qquad
    \subfloat{\includegraphics[width=0.45\textwidth]{fig/vbswh/fireworks/signal/vbswh_evt131104_rz_gen.png}}
    \caption{
...
The largest sub-leading background processes are \wjets (Fig.~\ref{fig:w_jets}), where a \PW is produced along with some number of quarks or gluons, and single-top production (Fig.~\ref{fig:single_t}), where only one top quark is produced. 
...
\begin{figure}[htb]
    ...
    \caption{
        The VBS jet combined invariant mass (left) and absolute difference in pseudorapidity (right) are plotted after applying the Preselection.
    }
...
\begin{figure}[htb]
    ...
    \caption{
        The variable \ST is plotted after applying the Preselection.
    }
...
\begin{figure}[htb]
    ...
    \caption{
        The \Htobb fat jet candidate soft drop mass (left) and ParticleNet Xbb score (right) are plotted after applying the Preselection.
    }
