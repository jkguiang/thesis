...
\begin{figure}[htb]
    ...
    \label{fig:vbswh_bkg} % leading background (ttbar)
\end{figure}
...
%         Feynman diagram for \wjets production in the single-lepton final state (a) and the production of a single top quark and \PW boson (b). 
%     }
