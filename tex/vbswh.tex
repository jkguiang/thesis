...
\begin{figure}[htb]
    \centering
    \subfloat[\wjets]{\includegraphics[width=0.4\textwidth]{fig/feynman/ttbar/ttV_onelep.pdf}\label{fig:w_jets}}\quad             % TODO: make this
    \subfloat[Single top]{\includegraphics[width=0.4\textwidth]{fig/feynman/ttbar/ttbar_onelep_extraJet.pdf}\label{fig:single_t}} % TODO: make this
    \caption{
...
\begin{figure}[htb]
    \centering
    \subfloat[1D exclusion of $\lambdaWZ = -1$]{\includegraphics[width=0.43\textwidth,valign=c]{fig/vbswh/boosted_r_vs_m2deltaLogL_unblinded_zoom.pdf}\label{fig:vbswh_limit_1D}}
    \subfloat[2D exclusion of \lambdaWZ values]{\includegraphics[width=0.47\textwidth,valign=c]{fig/vbswh/exclusion_2D_contours_unblinded.pdf}\label{fig:vbswh_limit_2D}}
    \caption{
