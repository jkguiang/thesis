...
\section{The signal}
The precise determinations of the magnitudes of \kW and \kZ~\cite{NatureHiggsCMS2022} were performed by studying processes that are predominantly quadratic in \kV---that is, \kW or \kZ enter the Feynman diagram twice. % add a feynman diagram?
...
\begin{figure}[htb]
    ...
    \caption{
        The \Htobb fat jet candidate soft drop mass (left) and ParticleNet Xbb score (right) plotted after applying the Preselection.
    }
