...
\begin{figure}[htb]
    ...
    \caption{
        Histograms of the invariant mass of the \WH system (left) and \ST (right) plotted from \VBSWH Monte Carlo simulation for $\kZ = +1$ (top) and $\kW = +1$ (bottom), demonstrating the Lorentz boost in the final state due to modifications to \lambdaWZ. 
    }
    \label{fig:vbswh_lhe}
\end{figure}
